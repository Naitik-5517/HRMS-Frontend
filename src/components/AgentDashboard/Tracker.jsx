                      ...
                      <td className="px-5 py-4 align-middle text-center">
                        {tracker.notes ? (
                          <div className="relative inline-flex group/tooltip">
                            <div className="inline-flex items-center justify-center text-blue-600 hover:text-white hover:bg-blue-600 transition-all bg-blue-50 rounded-lg p-2 shadow-sm cursor-help">
              ...
              <form className="p-4" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      className="w-full bg-slate-50 border-2 border-slate-300 rounded-lg px-4 py-3 text-sm font-medium text-slate-800 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all shadow-sm hover:bg-white"
                ...
                <div className="mb-3">
                  ...
                  <textarea
                    className="w-full bg-slate-50 border-2 border-slate-300 rounded-lg px-4 py-2 text-sm font-medium text-slate-800 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all shadow-sm hover:bg-white resize-none"
                    value={notes}
